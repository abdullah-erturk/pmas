...
Write-Host (' ' * 10) -NoNewline; Write-Host '2. Ohook Aktivasyon [Office] ' -ForegroundColor DarkYellow -NoNewline; Write-Host '(înerilen yîntem)' -ForegroundColor White; Write-Host ''; ^
